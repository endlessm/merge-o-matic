...
class ConfigTest(unittest.TestCase):
    ...
    def test_recursion(self):
        self.assertEqual(config.get("DISTROS", "target", "obs", "url"),
                         configTestsConfig.DISTROS["target"]["obs"]["url"])
...
class DistroTest(unittest.TestCase):
    ...
    def testConfig(self):
        self.assertEqual(self.distro.config("obs", "url"),
                         configTestsConfig.DISTROS["target"]["obs"]["url"])
        self.assertEqual(self.distro.config("nonExistantConfig", default=42),
                         42)
    ...
    def test_branch(self):
        ...
        self.assertEqual(homeBranch.config("obs", "url"),
